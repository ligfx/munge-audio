...
test: test.o test-engine.o tests/cppunitlite.a MNGLexer.o MNGParser.o AST.o SampleScanner.o Expression.o Unary.o LoopLayer.o
	$(COMPILER) $(CCFLAGS) -o $@ $^
...
clean:
	rm munge-extract MNGLexer.cpp MNGParser.o MNGLexer.o test.o test-engine.o SampleScanner.o Expression.o Unary.o AST.o munge-extract.o File.o LoopLayer.o $(cppunitlite_objects) tests/cppunitlite.a test
